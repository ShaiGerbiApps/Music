 ...
 *
 */
package com.shaigerbi.retromusic.activities.tageditor
...
import com.shaigerbi.retromusic.R.drawable
import com.shaigerbi.retromusic.activities.base.AbsBaseActivity
import com.shaigerbi.retromusic.activities.saf.SAFGuideActivity
import com.shaigerbi.retromusic.repository.Repository
import com.shaigerbi.retromusic.util.RetroUtil
import com.shaigerbi.retromusic.util.SAFUtil
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(com.shaigerbi.retromusic.R.string.pick_from_local_storage),
            getString(com.shaigerbi.retromusic.R.string.web_search),
            getString(com.shaigerbi.retromusic.R.string.remove_cover)
        )
